...
export const RemotionRoot = () => (
  <>
    <Composition id="HookOpener" component={HookOpener} durationInFrames={150} fps={30} width={1080} height={1920}
    ...
    <Composition id="TradeInsight" component={TradeInsight} durationInFrames={180} fps={30} width={1080} height={1920}
    ...
    <Composition id="QuoteCard" component={QuoteCard} durationInFrames={120} fps={30} width={1080} height={1920}
    ...
    <Composition id="BrandPromo" component={BrandPromo} durationInFrames={240} fps={30} width={1080} height={1920}
    ...
    <Composition id="ServiceAd" component={ServiceAd} durationInFrames={180} fps={30} width={1080} height={1920}
