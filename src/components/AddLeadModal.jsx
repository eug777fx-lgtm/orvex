    ...
    <AnimatePresence>
      {open && (
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={titleStyle}>Add New Lead</div>
          <div style={subtitleStyle}>Create a new prospect entry</div>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ marginTop: 6 }}>
            ...
            >
              <div style={{ ...sectionLabelStyle, marginBottom: 0 }}>Opportunity Flags</div>
              <div
                style={{
                  fontSize: 12,
