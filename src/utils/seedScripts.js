...
const SCRIPTS_LIBRARY_VERSION = 'v4-29'
...
const SEED_SCRIPTS = [
  ...
  /* ===== Papiamento (7) ===== */
  {
    ...
    problem_tags: ['no_website'],
    opening: 'Halo, ta e doño ta? Mi ta yama pasobra mi kier a comparti algo cu bo cu por yuda bo negoshi.',
    problem_hook: 'Mi a busca bo negoshi online i mi nota cu bo no tin un website. Esaki ta nifica cu clientenan ta buscabo pero no por haña bo — i nan ta bai pa bo competencia.',
    value_prop: 'Mi ta construi websitenan profesional pa negoshinan manera di bo — algo cu realmente trae clientenan nobo, no solamente un paginanan bunita.',
    cta: 'Bo ta dispuesto pa un yamada cortiku di 10 minüt pa mi mustrabo loke mi lo construi pa bo?',
    objections: [
      { trigger: 'no ta interesa', response: 'Ta normal! Por fabor, bo ta satisfecho cu cantidad di clientenan nobo cu bo ta haña awor?' },
      { trigger: 'muy caro', response: 'Mi ta compronde. Imagina si un solo cliente nobo paga tur e inversion. Mayoría di mi clientenan ta logra esei den e promé luna.' },
      { trigger: 'tin un ya', response: 'Ta chevere! E ta trayendo clientenan nobo regularmente of e ta keda asina?' },
      { trigger: 'yama mi despues', response: 'Por supuesto — ki ora ta bon pa bo? Mi lo pone den mi agenda awor mesora.' },
    ],
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_crm', 'manual_processes'],
    opening: 'Halo! Ta e doño ta? Mi tin un pregunta rapido — bo tin un sistema pa registra bo clientenan i trabounan, of ainda ta using papel i telefòn?',
    problem_hook: 'Hopi negoshinan cu mi ta papia cune ta pèrdè clientenan i trabounan pasobra nan no tin un sistema pa sigui. Tur cos ta den e cabes of un cuaderno.',
    value_prop: 'Mi ta construi sistèmanan di maneho di negoshi pa negoshinan manera di bo — un lugar pa maneha clientenan, trabounan, fakturanan i seguimento. Nunca mas pèrdè un oportunidad.',
    cta: 'Por mi mustrabo den 10 minüt loke esaki lo mira pa bo negoshi?',
    objections: [
      { trigger: 'no ta interesa', response: 'Ta bon! Curiosamente, con bo ta sigui bo clientenan i seguimientonan awor?' },
      { trigger: 'muy caro', response: 'Loke mi cobra ta generalmente recupera cu solamente 1-2 trabou extra cu bo lo a pèrdè. Por mi mustrabo e calculo?' },
      { trigger: 'tin algo ya', response: 'Ta bon! E ta construi specificamente pa bo tipo di negoshi of ta un herramienta generiko?' },
      { trigger: 'yama despues', response: 'Claro — ki dia ta bon pa bo?' },
    ],
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm'],
    opening: 'Halo [nòmber], ta Eugene di COS Studios. Nos a papia algun dia pasa tokante e sistema/website pa bo negoshi.',
    problem_hook: 'Mi a manda informacion i kier verificá si bo a haña oportunidad pa mira.',
    value_prop: 'Mi a traha cu varios negoshi similar i e resultadonan ta bon. Mi kier mustrabo loke ta posibel pa bo specificamente.',
    cta: 'Bo tin 10 minüt e siman aki pa un yamada rapido?',
    objections: [
      { trigger: 'no a mira e informacion', response: 'Ningun problema — por mi manda e informacion awor mesora. Ki ta e mihor WhatsApp of email?' },
      { trigger: 'ainda ta pensando', response: 'Por supuesto — ki pregunta mi por kontestabo pa yudabo dicidi?' },
      { trigger: 'muy oküpa', response: 'Mi ta compronde — esaki ta exactamente pakiko e sistema ta vale e 10 minüt. E ta salbabo tempu tur siman.' },
    ],
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm'],
    opening: 'Halo [nòmber], ta Eugene. Mi ta sigui riba e propuesta cu mi a manda.',
    problem_hook: 'Mi sa bo a considera esei — i honestamente, cada siman sin e sistema ta clientenan cu ta bai pa bo competencia.',
    value_prop: 'Tur cos cu nos a discutí ta inclui — e construccion, setup, i mi ta disponibel pa soporte despues. Mi ta maneha tur cos for di principio te fin.',
    cta: 'Bo ta listo pa cuminsa e siman aki? Mi por tin cos moviendo den 24 ora di bo confirmacion.',
    objections: [
      { trigger: 'master mas tempu', response: 'Ta bon — ki exactamente ta deteniébo? Laga nos trata esaki awor mesora.' },
      { trigger: 'muy caro', response: 'Laga nos papia tokante esei — ta e cantidad total of e timing? Tin un manera di structura esaki miho pa bo.' },
      { trigger: 'no ta listo', response: 'Mi ta respeta esei — ki ora bo kier bo lo ta listo? Mi kier asegura un lugar pa bo.' },
    ],
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm'],
    opening: 'Mi ta compronde completamente — presupuesto ta siempre un consideracion real i mi ta respeta esei.',
    problem_hook: 'Pero e pregunta real no ta loke e kosta — ta loke e kosta pa NO tene. Cada luna sin un website of sistema ta trabounan cu ta bai pa competencia.',
    value_prop: 'Mi precio ta estructura di tal manera cu e promé 1-2 trabou extra cu bo haña paga tur e inversion. Despues di esei ta puro ganashi. Mi tambe tin opcionnan di pago flexible.',
    cta: 'Por mi mustrabo e kalkulacion pa bo mira si e tin sentido?',
    objections: [
      { trigger: 'ainda muy caro', response: 'Ki presupuesto lo funciona pa bo? Dami un nümero i laga nos mira si nos por structura algo.' },
      { trigger: 'no ta bal e pena', response: 'Ta hunsto — ki lo bal e pena pa bo? Ki resultado bo lo mester mira?' },
      { trigger: 'kizas despues', response: 'Ki ora specificamente? Mi ta pregunta pasobra negoshinan cu ta warda generalmente ta pèrdè mas — nan competencia ta sigui move.' },
    ],
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm'],
    opening: 'Halo [nòmber]! Bon bini na famia COS Studios 🎉 Mi ta contento cu bo a dicidi avansa.',
    problem_hook: 'Awor nos ta cuminsa construi algo cu realmente lo cambia con bo negoshi ta opera.',
    value_prop: 'E siguiente paso ta un yamada di descubrimento di 30 minüt caminda nos ta papia tokante con bo negoshi ta funciona exactamente. Esei ta asegura cu loke nos construi ta perfect pa bo.',
    cta: 'Ki dia i ora ta bon pa bo esa siman aki? Mi ta flexible.',
    objections: [],
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm', 'manual_processes'],
    opening: 'Halo [nòmber], ta Eugene di COS Studios. Mi a purba kontaktabo e siman pasa tokante algo cu mi kere lo yuda bo negoshi.',
    problem_hook: 'Mi ta construi websitenan i sistèmanan pa negoshinan manera di bo — hopi ta pèrdè clientenan simplemente pasobra nan ta dificil pa haña online of nan no tin sistema.',
    value_prop: 'Mi ta mantene e cos simple, asequibel i mi ta maneha tur cos for di cuminso te fin. Bo no mester sa di tecnologia.',
    cta: 'Si esaki ta relevant, yama mi bèk na [bo nümero] of mi lo purba bo otro bez e siman aki.',
    objections: [
      { trigger: 'no ta interesa', response: 'Ningun problema — ki parti no ta relevant pa bo negoshi?' },
      { trigger: 'tin algo ya', response: 'Ta bon di scucha — ki bo ta usando pa bo website i maneho di cliente?' },
    ],
  },
