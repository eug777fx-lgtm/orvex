...
const SEED_SCRIPTS = [
  ...
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm'],
    opening: 'Halo [nòmber]! Bon bini na famia Lithos Labs! 🎉 Mi ta realmente contento cu bo a dicidi avansa.',
  ...
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm', 'manual_processes'],
    opening: 'Halo [nòmber], ta Eugene di Lithos Labs ta. Mi a purba kontaktabo e siman pasa tokante algo cu mi kere lo yuda bo negoshi.',
  ...
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm'],
    opening: 'Hola [nombre], soy Eugene de Lithos Labs. Hablamos hace unos días sobre el sistema/sitio web para tu negocio.',
  ...
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm'],
    opening: '¡Hola [nombre]! ¡Bienvenido a la familia Lithos Labs! 🎉 Estoy muy contento de que hayas decidido avanzar.',
  ...
  },
  {
    ...
    industry_tags: ['plumber', 'electrician', 'hvac', 'pest control', 'landscaping', 'cleaning', 'restaurant', 'salon', 'barbershop', 'gym'],
    problem_tags: ['no_website', 'no_crm', 'manual_processes'],
    opening: 'Hola [nombre], soy Eugene de Lithos Labs. Intenté contactarte la semana pasada sobre algo que creo ayudaría a tu negocio.',
